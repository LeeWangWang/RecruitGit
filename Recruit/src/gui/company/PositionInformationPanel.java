/**@FileName:PositionInformationPanel.java
 * @Description:
 * @Author:周天乐Sio
 * @Date:2019年1月6日
 */
 ...
 * @Date:2019年1月6日
 */
public class PositionInformationPanel  extends JPanel{
	 ...
	 * @throws Exception
	 */
	public PositionInformationPanel(List<String> itemNames,List<String> talNames,List<JComponent> items,List<JButton> btnCommond,
