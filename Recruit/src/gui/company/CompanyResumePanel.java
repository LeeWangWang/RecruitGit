/**@FileName:CompanyResumePanel.java
 * @Description:
 * @Author:周天乐Sio
 * @Date:2019年1月6日
 */
 ...
 * @Date:2019年1月6日
 */
public class CompanyResumePanel extends JPanel{
	/** serialVersionUID */
	 ...
	 * @throws Exception
	 */
	public CompanyResumePanel(List<String> itemNames,List<String> talNames,List<JComponent> items,List<JButton> btnCommond,
			int countOneLine) throws Exception  {
		int companyId = 1;
		new ResumeServImpl(new ResumeDaoImpl());
